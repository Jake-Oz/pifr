...
MOS Schedule 3 Section 2.2 Unit 2.2.1 8.3.1: Determine whether a flight may proceed based on the following: (a) altitude; (b) aircraft equipment; (c) IFR navigation requirements.
