...
MOS Schedule 3 Section 2.2 Unit 2.2.1 13.3.1: Demonstrate knowledge of radio procedures in Class G airspace and at non-controlled aerodromes.

## Why it matters

Class G and non-controlled aerodrome radio procedures are exam-heavy because the pilot must select frequencies, broadcast at the right times and use standard formats without ATC prompting.
...
TODO: Add Class G and CTAF broadcast examples after selecting route, aerodrome and frequency-change scenarios.
