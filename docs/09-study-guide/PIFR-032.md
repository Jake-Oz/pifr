...
MOS Schedule 3 Section 2.2 Unit 2.2.1 8.1.2: Determine the dimensions of the significant safety sector when calculating LSALT for a route not published on a chart.
