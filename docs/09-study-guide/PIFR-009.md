...
MOS Schedule 3 Section 2.2 Unit 2.2.1 4.1.1: State the IFR operations a single-engine aircraft is limited to.
...
- Source status notes: Verified against current CASR 1998 compilation 101 (F2026C00286). Do not infer operational limits beyond the PIFR endorsement privileges and limitations.
