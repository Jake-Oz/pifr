...
MOS Schedule 3 Section 2.2 Unit 2.2.1 15.2.1: State how NDB indications or range may be affected by the following: (a) coastal refraction; (b) night error; (c) thunderstorms; (d) mountainous areas; (e) types of terrain; (f) altitude of aircraft.

## Why it matters

NDB range and indication errors are directly examinable, and CASA's NDB/ADF operational notes give the source-backed error mechanisms and range cautions.
...
TODO: Add NDB error/range scenarios from the CASA notes after selecting concise exam-style fact patterns.
