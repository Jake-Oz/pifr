...
| Ground radar safety precautions | Partial locator for PIFR-044. CAO 20.9 has been identified as the likely official source, but the current authorised document and exact provision still need repository verification. | Verify current CAO 20.9 before adding safety-distance details, examples, or answer text. |
...
| Radio navigation technique | Source gap for PIFR-070 to PIFR-083. Operational VOR/NDB/DME rules are mapped, but cockpit indication, intercept and ADF calculation technique is not sourced. | Verify a public official technique source before adding formulas or worked examples. |
