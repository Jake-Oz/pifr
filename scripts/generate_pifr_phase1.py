...
STUDY_CONTENT = {
    ...
    "PIFR-044": {
        "why": "Ground radar precautions are a direct aircraft and apron safety issue: CAO 20.9 section 6 gives the official operating limits for higher-power aircraft radar equipment on the ground.",
        "notes": [
            "Use CAO 20.9 section 6 as the first hard-copy/source lookup point for aircraft radar equipment ground-operation precautions.",
            "Section 6.2 applies to radar equipment with nominal peak power output above 25 kW.",
            "With the antenna rotating in normal mode, the scanned sector must be clear to 37 m from the antenna of refuelling/defuelling aircraft, fuel tankers/tanks/storage areas, persons or cargo, and other aircraft or hangars.",
            "With the antenna stationary and the beam directed toward those objects, separation must exceed 60 m.",
            "The 37 m and 60 m distances may be reduced by 75% when an approved beam attenuating device is used.",
            "Do not energise radar in a hangar or enclosure unless a suitable microwave energy absorbing shield is fitted over the antenna.",
            "Do not operate the equipment in an aircraft that is being refuelled or defuelled.",
            "Currency note: this is taken from supplied Federal Register compilation F2011C00881, prepared 11 November 2011. Independently verify the latest authorised compilation before treating currency as complete.",
        ],
        "traps": [
            "Do not confuse airborne weather radar equipment carriage references with ground-operation safety precautions.",
            "Do not apply the 37 m normal-mode clearance to a stationary beam; section 6.2.2 uses 60 m.",
            "Do not forget the threshold: section 6 applies to radar equipment with nominal peak power output above 25 kW.",
            "Do not operate radar during refuelling or defuelling.",
        ],
        "examples": "TODO: Add worked examples after checking whether F2011C00881 remains the current authorised compilation.",
        "exam_use": [
            "For the exam index, start with CAO 20.9 section 6 when the question asks about operating aircraft radar equipment on the ground.",
            "Look for the section heading `Ground operation of aircraft radar equipment`, then read clauses 6.1 and 6.2.",
            "Memorise the lookup pattern, not just the numbers: applicability above 25 kW, rotating antenna 37 m, stationary beam 60 m, attenuator reduction, hangar shielding, and no operation while refuelling/defuelling.",
        ],
    },
    "PIFR-045": {
    ...
    "PIFR-070": {
        ...
        "examples": "TODO: Add VOR indication drills using selected VORs and chart examples.",
        "exam_use": [
    ...
    "PIFR-072": {
        ...
        "examples": "TODO: Add OBS command-indication drills using selected inbound and outbound tracks.",
        "exam_use": [
    ...
    "PIFR-073": {
        ...
        "examples": "TODO: Add VOR intercept-heading calculations as clearly separated worked examples after selecting suitable scenarios.",
        "exam_use": [
    ...
    "PIFR-076": {
        ...
        "examples": "TODO: Add NDB error/range scenarios from the CASA notes after selecting concise exam-style fact patterns.",
        "exam_use": [
    ...
    "PIFR-077": {
        ...
        "examples": "TODO: Add NDB selection examples after selecting route/aids and chart context.",
        "exam_use": [
    ...
    "PIFR-078": {
        ...
        "examples": "TODO: Add station-passage, abeam and drift examples after selecting concise ADF indications.",
        "exam_use": [
    ...
    "PIFR-079": {
        ...
        "examples": "TODO: Add NDB track calculations using selected heading/RB/deviation/variation values.",
        "exam_use": [
    ...
    "PIFR-080": {
        ...
        "examples": "TODO: Add NDB intercept-heading examples after selecting desired track, heading, relative bearing and drift facts.",
        "exam_use": [
    ...
    "PIFR-081": {
        ...
        "examples": "TODO: Add inbound NDB intercept examples after selecting simple track/heading/RB fact patterns.",
        "exam_use": [
    ...
    "PIFR-082": {
        ...
        "examples": "TODO: Add relative-bearing interception calculations after selecting heading and desired-track values.",
        "exam_use": [
...
def reference_summary(mapped):
    ...
    summary = {field: mapped.get(field, "TODO") for field in official_fields}
    if "CASA guidance" in mapped:
        summary["CASA guidance"] = mapped["CASA guidance"]
    return summary
...
def exam_index(objs, reference_map):
    ...
    for obj in objs:
        ...
        locator = "TODO"
        for field in ["Part 91 MOS", "Part 61", "Part 91", "AIP reference", "CAR", "ERSA reference", "ERC LOW reference", "TAC reference", "PCA reference", "CASA guidance"]:
            value = refs.get(field, "TODO")
            if value != "TODO":
                locator = f"{field}: {value}"
                break
        row = [
            obj["id"],
            obj["mos_ref"],
...
def study_files(objs, reference_map):
    ...
    for obj in objs:
        ...
        official_rows = [
            f"|{field}|{value}|"
            for field, value in reference_summary(mapped).items()
        ]
